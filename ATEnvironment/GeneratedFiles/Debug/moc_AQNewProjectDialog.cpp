...
#include "../../../src/ATEnvironment/AQNewProjectDialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AQNewProjectDialog_t, stringdata) + ofs \
...
const QMetaObject AQNewProjectDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AQNewProjectDialog.data,
      qt_meta_data_AQNewProjectDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AQNewProjectDialog.stringdata))
        return static_cast<void*>(const_cast< AQNewProjectDialog*>(this));
